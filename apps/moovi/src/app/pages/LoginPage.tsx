      ...
      <div tw="h-full flex flex-col p-8">
        ...
        <div tw="flex-1 flex flex-col items-center justify-center">
          <div tw="text-center mb-8">
            <div tw="text-cpc-cyan-500 text-4xl font-bold mb-2">MOOVI</div>
            <div tw="text-cpc-green-500 text-sm">PERSONAL MOVIE COLLECTION v1.0</div>
          </div>
          ...
          <div css={[tw`text-cpc-cyan-500 text-xs mt-8 text-center`, animatePulse]}>
            ...
            <div tw="mt-1 text-cpc-green-900">Powered by TMDB & OMDB</div>
          </div>
        </div>
      </div>
    </CpcLayout>
