...
export function HomePreviewPage() {
  ...
  const handleSteamDoorOpen = () => {
    setIsEntering(true)
    setTimeout(() => { window.location.href = getAppUrl('steam') }, 800)
  }
  ...
  const gamepadIcon = (
    <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Controller body */}
      <path d="M10 20C10 15 14 11 19 11H33C38 11 42 15 42 20V30C42 35 38 39 33 39H19C14 39 10 35 10 30V20Z" fill="#1a1a1a" stroke="#00FF00" strokeWidth="2.5" />
      {/* Left grip */}
      <path d="M10 28L5 36C4 38 5 40 7 40H12V28H10Z" fill="#1a1a1a" stroke="#00FF00" strokeWidth="2" />
      {/* Right grip */}
      <path d="M42 28L47 36C48 38 47 40 45 40H40V28H42Z" fill="#1a1a1a" stroke="#00FF00" strokeWidth="2" />
      {/* D-pad vertical */}
