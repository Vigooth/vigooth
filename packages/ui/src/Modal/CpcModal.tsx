 ...
 * read what it covers, and a double-click on the bar brings it back. Every
 * opening starts centred. See `useDraggable` for how the offset is applied.
 */
export function CpcModal({
  ...
  const { ref, handleProps } = useDraggable<HTMLDivElement>({
    enabled: draggable,
    resetOn: open,
  });
